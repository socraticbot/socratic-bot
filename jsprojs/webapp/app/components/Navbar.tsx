...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[#FDFBF9] border-b border-gray-200 relative z-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          {/* Logo/Home Link */}
          <Link href="/landing" className="flex items-center gap-1.5 sm:gap-2 hover:opacity-80 transition-opacity flex-shrink-0 min-w-0">
            <Image
              src="/socraticlogo.png"
              alt="Socratic Bot"
              width={32}
              height={32}
              className="w-6 h-6 sm:w-8 sm:h-8 cursor-pointer flex-shrink-0"
            />
            <span className="text-sm sm:text-lg font-serif text-black cursor-pointer truncate">Socratic.bot</span>
          </Link>
